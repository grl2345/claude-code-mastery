---
title: "Claude Code 开发该一步到位还是小步快跑？粒度选择指南"
module: m2-thinking
order: 7
group: "渐进式开发"
description: "**小步快跑比一步到位更高效，因为返工才是真正吃掉时间的怪兽。** 每步控制在 5-15 分钟、30-100 行代码，审查通过立即 commit。判断标准：你能在 2 分钟内完成审查的量。"
duration: "12 分钟"
level: "需编程基础"
...
**因为 AI 在错误基础上继续堆砌代码的速度和写对的速度一样快，一步到位有错误放大、审查困难、回退代价高三个致命问题。** 我刚开始用 Claude Code 的时候，干过一件特别「爽」的事：把一整个功能的需求写成一段超长的 prompt，按下回车，然后看着它哗哗地输出了几百行代码。当时的感觉是——这也太快了吧，以后写代码岂不是轻松加愉快？
...
**每步 5-15 分钟，产出 30-100 行代码，审查通过后立即 commit。** 我现在的工作节奏是这样的：每个步骤控制在 5 到 15 分钟，让 Claude Code 产出大概 30 到 100 行代码。拿到代码后快速审查，确认没问题就立刻 commit。
...
**经验法则：你能在 2 分钟内完成审查的量。** 如果拿到代码后需要花 10 分钟才能看完，说明粒度太大了。如果拿到代码后需要花 10 分钟才能看完，说明粒度太大了，下次应该拆得更细。
...
**先从一个简单功能开始练习「小步 → 审查 → commit」循环，坚持一两周后整体效率会因返工减少而明显提升。** 说实话，一开始执行小步快跑是有点别扭的。明明 AI 能一口气搞定，非要自己拆成好几步，感觉在人为制造麻烦。但坚持了一两周之后，我发现整体效率反而提高了——因为返工的次数大幅减少，而返工才是真正吃掉时间的怪兽。
